...
checkpointer = create_model_checkpoint('models', 'vae_seq2seq_experiment10')
...
vae.save_weights('models/vae_lstm_experiment10.h5')
...
output = open('/nfs/home/6/tempker/aae/generated_text/VAE_generated/500000_experiment10_5atatime.pkl','wb')
pk.dump(gen, output)   
print('Saved!')
