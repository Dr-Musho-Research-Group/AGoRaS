...
data_GAN = open('/nfs/home/6/tempker/GAN/Dataset/pkls/reactions-training-data.pkl', 'rb')
...
training = train_data[:28000].astype(np.int32)
test = train_data[28000:32000].astype(np.int32)
...
checkpointer = create_model_checkpoint('models', 'vae_seq2seq_test_lr1e-5_std05')
...
vae.save_weights('/.nfs/home/6/tempker/aae/models/vae_lstm_8420_weights.h5')
...
new_sents_interp(sentence1, sentence2, 10)
...
for n in range(0, 45000):
    if len(gen) < 500000:
        num1 = randint(0, 32056)
        num2 = randint(0, 32056)
...
generated = [x for x in gen if x not in org_eqs]
    
output = open('/nfs/home/6/tempker/aae/generated_text/VAE_generated/generated_eq_5atatime_bestloss_uses8420.pkl','wb')
pk.dump(gen, output)   
